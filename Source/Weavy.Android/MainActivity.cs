...
using System;
using Weavy.Droid.Notifications;
using Android.Views;
using Xamarin.Forms.Platform.Android;
using System.Threading.Tasks;
using Firebase.Iid;

namespace Weavy.Droid {
    [Activity(Label = "Spaces", 
    ...
    public class MainActivity : FormsAppCompatActivity
    {
        ...
        private void CreateNotificationChannel() {
            ...
            var description = $"General notifications from {Helpers.Constants.DisplayShortName}";
            var channel = new NotificationChannel(Constants.NOTIFICATION_CHANNEL_ID, name, NotificationImportance.High) {
